...
export default function Footer() {
  return (
    <footer id="footer" className="bg-darkViolet p-8">
      <div className="flex flex-col lg:flex-row lg:items-start justify-center items-center lg:justify-around space-y-4 lg:space-y-0">
        <svg
        ...
        <div className="space-y-2 flex flex-col justify-center text-center lg:text-left">
        ...
        <div className="flex space-x-5">
          ...
          <img src={Pintrest} alt="" className="cursor-pointer" />
        </div>
      </div>
    </footer>
  );
